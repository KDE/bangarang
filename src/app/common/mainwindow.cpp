...
void MainWindow::enableTouch() {
    ...
    ui->widgetSet->setMinimumHeight(52);
    ui->widgetSet->setMaximumHeight(52);
    ui->mediaListWidgetSet->setMinimumHeight(52);
    ui->mediaListWidgetSet->setMaximumHeight(52);
    ui->mediaListWidgetSet1->setMinimumHeight(52);
    ui->mediaListWidgetSet1->setMaximumHeight(52);
    ...
    ui->mediaPrevious->setMinimumSize(tTouchable + 6, tTouchable);
    ui->mediaNext->setMinimumSize(tTouchable + 6, tTouchable);
    ui->mediaPlayPause->setMinimumSize(52, 50);
    ui->mediaPlayPause->setIconSize(QSize(42, 42));
